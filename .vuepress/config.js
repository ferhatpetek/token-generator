...
module.exports = {
  ...
  head: [
    ...
    ['meta', { property: 'og:url', content: 'https://bep20.github.io/token-generator' }],
    ['meta', { property: 'og:image', content: 'https://bep20.github.io/token-generator/assets/images/todo.jpg' }], // eslint-disable-line max-len
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:image', content: 'https://bep20.github.io/token-generator/assets/images/todo.jpg' }], // eslint-disable-line max-len
    ['script',
      {
